...
class ActionRepository extends RepositoryAbstract {
	 ...
	 *      id	                    Action ids	                                                                                'id="20346, 20346"'
	 *      name	                names of the action	                                                                        'name="Like, Upvote"'
	 *      kind	                the kind of the action set during the creation of the action	                            'kind="user_to_user"'
	 *      arbitrary_amount	    actions where the amount is set during creation or provided at execution	                'arbitrary_amount= false'
	 *      arbitrary_commission	user_to_user actions where the commission is set during creation or provided at execution	'arbitrary_commission=true'
	 *
	 * @throws
	 * @return ActionModel[]
	 */
